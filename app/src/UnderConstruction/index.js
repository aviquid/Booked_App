  ...
  render() {
    return (
      <FlexCol className="size1 ">
        <SBAC
          className="w-full p-l-80 p-r-80 p-t-22 p-lr-15-sm"
          style={{ textAlign: 'center' }}
        >
          <div className="wrappic1 m-r-30 m-t-10 m-b-10 logo">BookedUp!</div>
        </SBAC>
        ...
        <div className="flex-w flex-c-m p-b-35">
          <a
            href="https://play.google.com/store/apps/details?id=com.bookedup.thejesh.test_bookyourbook"
            target="__blank"
          >
